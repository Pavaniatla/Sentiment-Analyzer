...
def build_gru_model(input_len, vocab_size=10000, num_classes=5):
    model = Sequential()
...
if __name__ == "__main__":
    ...
    with open("models/GRU_tokenizer.pkl", "wb") as f: pickle.dump(tokenizer, f)
    with open("models/GRU_label_encoder.pkl", "wb") as f: pickle.dump(label_encoder, f)
